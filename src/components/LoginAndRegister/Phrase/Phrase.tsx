        ...
        <div>
          ...
          <div>
            <svg width="24" height="24" viewBox="0 0 30 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="Icon  5">
                <path id="Oval" opacity="0.15" fillRule="evenodd" clipRule="evenodd" d="M15 30.4515C23.2843 30.4515 30 23.7358 30 15.4515C30 7.16727 23.2843 0.451538 15 0.451538C6.71573 0.451538 0 7.16727 0 15.4515C0 23.7358 6.71573 30.4515 15 30.4515Z" fill="#0FAB60" />
